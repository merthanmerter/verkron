...
![EIS](/images/extrusionsim-dashboard.webp)
...
## Branding
Beyond web development, we created the full brand identities for Inalcom and ExtrusionSim — including their logos, visual guidelines and overall brand direction. We continue to support them as their dedicated design partner.

![EIS](/images/extrusionsim-logo.png)